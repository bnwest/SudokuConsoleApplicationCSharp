...
input_data = [
    ...
    (7, 9, 8),
    (3, 4, 9),
    # Since the previous Sudoku contains only one unique solution,
    # we remove some numers from the board to obtain a Sudoku
...
prob.writeLP("Sudoku.lp")  # unsure why we do this?
...
while True:
    ...
    # The solution is outputed if it was deemed "optimal"
    # i.e met the constraints
    if pulp.LpStatus[prob.status] == "Optimal":
        ...
        # The constraint is added so that the same solution
...
print(f"{num_solutions} solutions written to sudokuout.txt")
