...
namespace Sudoko
{
   ...
   // failed to solve - naked quad in grid(2,3), exclude based on colors)
   ...
   // 17 l5
   // failed to solve - naked quad in column 3 at start, Simple Sudoku fails to solve
